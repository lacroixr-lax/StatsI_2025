...
\begin{enumerate}
	...
	\item [(d)] Evaluate the model fit for this regression.  What does this	tell us about the importance of yard signs versus other factors that are not modeled?
		...
		\textsmaller[1]{The p-value for the F-test evaluating this model was found to be 0.999, which indicates that the presence of yard signs is not significant in predicting vote share and that we cannot reject the null hypothesis that $\beta_{1}$ and $\beta_{2}$ are equal to 0. This means that other factors that are not modeled may be more important in predicting vote share than the presence of yard signs.}
